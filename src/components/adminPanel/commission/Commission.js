...
export default function Commission() {
    ...
    const { setPopup, setCommissionFormValue, commissionvalue, originalList, popup, commissionList, setCommissionList, inputFields, setInputFields, chooseGateway, setChooseGateway, updatedata, setCatId
            ...
            <div className="container-fluid classatten-wrapper  mt-3 ps-4 pe-4">
                <div className="row mt-3">
                    <div className="page-header">
                        <div className="text-start  page-title">Commission Setup</div>
                            ...
                            subHeaderComponent={
                                <>
                                    ...
                                    <div className="upper-dataTbl mx-2">
                                        <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Gateway</label>
                                        <select
                                            style={{ fontSize: "11px" }}
                                            name="snotifiaction"
                                            value={chooseGateway}
