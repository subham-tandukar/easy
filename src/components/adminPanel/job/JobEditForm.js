...
export default function JobEditForm() {
    ...
    const {
        jobFormValue, setJobFormValue, jobFormError, setJobFormError, setEditPop, isEditSubmit, setIsEditSubmit, image, setImage, isUploaded, setIsUploaded, setTypeFile, negotiable, setNegotiable, departmentList, subdepartmentList, designationList, shiftList, jobvalue, getJobList, titleId
    ...
    useEffect(() => {
        ...
        if (Object.keys(jobFormError).length === 0 && isEditSubmit) {
