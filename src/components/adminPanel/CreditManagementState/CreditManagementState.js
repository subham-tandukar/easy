...
function CreditManagementState(props) {
    ...
    const [approveStatusFormValue, setApproveStatusFormValue] = useState(approvestatusvalue);
    ...
    const [rejectStatusFormValue, setRejectStatusFormValue] = useState(rejectstatusvalue);
    ...
    return (
        <CreditManagementContext.Provider
            value={{
                ...
                approvePopup, setApprovePopup, handleApprove, handleApproveTrue, handleApproveFalse,
                handleRejectFalse, handleRejectTrue, handleReject, rejectPopup, originalList, setOriginalList, chooseCooperative, setChooseCooperative, status, setStatus, creditList, setCreditList,
                approveStatusFormError, setApproveStatusFormError, isSubmit, setIsSubmit, approvestatusvalue, approveStatusFormValue, setApproveStatusFormValue,
                rejectStatusFormError, setRejectStatusFormError, rejectIsSubmit, setRejectIsSubmit, rejectStatusFormValue, setRejectStatusFormValue, rejectstatusvalue
            }}
        >
            {props.children}
        </CreditManagementContext.Provider>
