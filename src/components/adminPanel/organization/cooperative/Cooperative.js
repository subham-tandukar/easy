...
export default function Cooperative() {
    ...
    const {
        cooperativePopup, setCooperativePopup, cooperativeEditPopup, setCooperativeEditPopup, isSubmit, setIsSubmit, editIsSubmit, setEditIsSubmit, originalList, setOriginalList, allowApp, setAllowApp, loading, setLoading, cooperativeFormValue, setCooperativeFormValue, cooperativeFormError, setCooperativeFormError, cooperativevalue, editPop, cooperativeList, categoryPopup, setCategoryPopup, setAssignPopup, assignPopup, setCooperativeList, deactivateDepart, setCooCode,
        paidOption, setPaidOption, utilityOption, setUtilityOption, creditLimit, setCreditLimit, expiredOption, setExpiredOption, liveOption, setLiveoption, device, setDevice, status, setStatus, setAssignFormValue
                    ...
                    <>
                        <div className="ln-verition d-flex">
                            <button
                                ...
                                onClick={() => assignCommission([row.cooperativeCode, row.categoryID])}
                            >
                                Assign Comm.{" "}
                            </button>
                            |
                            ...
                            <button
                                ...
                                class="btn btn-sm"
                                style={{ background: "var(--button-color)", color: "white" }}
                                onClick={() => changeStatus(row.staffID, row.allowApp, row.cooperativeCode)}
                            >
            ...
            <div className="container-fluid classatten-wrapper  mt-3 ps-4 pe-4">
                <div className="row mt-3">
                    <div className="page-header">
                        <div className="text-start  page-title">Cooperative</div>
                                ...
                                subHeaderComponent={
                                    <>
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Paid Option</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="paidOption"
                                        ...
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Utility Option</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="utilityOption"
                                                className="form-select form-select-sm"
                                        ...
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Credit Limit</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="creditLimit"
                                                className="form-select form-select-sm"
                                        ...
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Expiry Date</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="expiredOption"
                                                className="form-select form-select-sm"
                                        ...
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Live</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="liveOption"
                                                className="form-select form-select-sm"
                                        ...
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Status</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="status"
                                                className="form-select form-select-sm"
                                        ...
                                        <div className="col-md-2 col-sm-2 col-lg-2 me-2">
                                            <label style={{ fontSize: "14px", textAlign: "left", display: "block" }}>Device</label>
                                            <select
                                                style={{ fontSize: "11px" }}
                                                name="device"
                                                className="form-select form-select-sm"
