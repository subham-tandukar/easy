...
export default function Service() {
  ...
  useEffect(() => {
    if (Object.keys(staffFormError).length === 0 && finalSubmit) {
      const dataForm = {
        ComID: User.CompanyId,
        Flag: "I",
        StaffID: User.UID,
        UserID: staffFormValue.userID,
        UserCode: staffFormValue.userCode,
        DeviceCode: staffFormValue.deviceCode,
        MobileID: staffFormValue.mobileCode,
        ...
        DateOfBirth: staffFormValue.dateOfBirth,
        ...
        MaritalStatus: staffFormValue.marital,
        Image: image,
        EnrollDate: staffFormValue.enrollDate,
        WorkingStatus: notWorking ? 2 : 1,
        LeavedDate: staffFormValue.leaveDate ? staffFormValue.leaveDate : "-",
        ...
        SubDepartment: staffFormValue.subDepartment,
