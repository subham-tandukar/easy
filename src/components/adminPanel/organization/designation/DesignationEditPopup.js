...
export default function DesignationEditPopup({
  setDesignationEditPopup,
  reload,
  setReload,
  ...
  useEffect(() => {
    if (Object.keys(designationFormError).length === 0 && isEditSubmit) {
      const dataForm = {
      ...
      <div className="container leavenotepopup-wrapper">
        <div className="subdepartmentpopup-inner ">
          <div className="popUpHeader ps-0 pe-0">
            <div className="popUpTitle">Designation Edit</div>
