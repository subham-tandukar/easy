...
export default function ProductEditPopup({
  ...
  const [isEditSubmit, setEditIsSubmit] = useState(false);
  ...
  useEffect(() => {
    if (Object.keys(productFormError).length === 0 && isEditSubmit) {
      const dataForm = {
      ...
      <div className="container leavenotepopup-wrapper">
        <div className="productpopup-inner ">
          <div className="popUpHeader ps-0 pe-0">
            <div className="popUpTitle">Product Edit</div>
