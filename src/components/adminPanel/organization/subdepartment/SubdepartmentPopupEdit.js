...
export default function SubdepartmentPopupEdit({
  ...
  useEffect(() => {
    if (Object.keys(subdepartmentFormError).length === 0 && editIsSubmit) {
      const dataForm = {
      ...
      <div className="container leavenotepopup-wrapper">
        <div className="subdepartmentpopup-inner ">
          <div className="popUpHeader ps-0 pe-0">
            <div className="popUpTitle">Sub Department Edit</div>
