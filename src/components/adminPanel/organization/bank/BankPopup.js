...
export default function BankPopup({
  ...
  useEffect(() => {
    const dataForm = {
      FetchURL: `${appURL}api/org-staff?ComID=${User.CompanyId}&BranchID=${User.BranchId}&DepartmentId=${bankFormValue.department}&SubDepartmentId=${bankFormValue.subDepartment}`,
      Type: "GET",
    };
      ...
      <div className="container leavenotepopup-wrapper">
        <div className="bankpopup-inner ">
          <div className="popUpHeader ps-0 pe-0">
            <div className="popUpTitle">Bank</div>
