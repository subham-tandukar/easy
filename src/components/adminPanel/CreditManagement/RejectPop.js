...
export default function RejectPop({ handleRejectTrue, handleRejectFalse }) {
    ...
    const { rejectStatusFormError, setRejectStatusFormError, rejectIsSubmit, setRejectIsSubmit, rejectStatusFormValue, setRejectStatusFormValue, rejectstatusvalue } = useContext(CreditManagementContext)
                        ...
                        <div className="col-md-12 col-sm-12 col-lg-12">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    id="remarks"
                                />
                                <p className="errormsg " style={{ textAlign: "left" }}>{rejectStatusFormError.remarks}</p>
                            </div>
                        </div>
                    </div>
