...
export default function CreditManagement() {
    ...
    const { approvePopup, handleApprove, handleApproveTrue, handleApproveFalse,
                    ...
                    <>
                        {row.isApprove === "PENDING" ?
                            ...
                            : row.isApprove === "APPROVED" ?
                                "Approved"
                                : row.isApprove === "DECLINED" ? "Rejected" : ""}
                    </>
                );
            },
        },
            ...
            <div className="container-fluid classatten-wrapper  mt-3 ps-4 pe-4">
                <div className="row mt-3">
                    <div className="page-header">
                        <div className="text-start  page-title">Credit Management</div>
